...
# === CORS configuration ===
# In development we allow any origin so the Flutter app can reach the API
# from a phone, emulator, or web browser. In production, replace with a
# specific list of allowed origins.
